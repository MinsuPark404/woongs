-- 테이블 생성 SQL - cms_managers
CREATE TABLE cms_managers
(
    `manager_idx`         INT UNSIGNED    NOT NULL    AUTO_INCREMENT,  -- 관리자 순번  
    `manager_email`       VARCHAR(50)     NULL,                        -- 관리자 이메일
    `manager_password`    VARCHAR(60)     NULL,                        -- 관리자 비밀번호
    `manager_name`        VARCHAR(30)     NULL,                        -- 관리자 이름
    `manager_role`        VARCHAR(20)     NULL,                        -- 관리자 역할 
    `manager_status`      VARCHAR(20)     NULL,                        -- 관리자 상태 
    `manager_created_at`  DATETIME        NULL        DEFAULT now(),   -- 관리자 등록일자 
    `manager_updated_at`  DATETIME        NULL,                        -- 관리자 수정일자 
    `manager_last_login`  DATETIME        NULL,                        -- 관리자 최종 로그인 
...
(
    ...
    `business_manager`     VARCHAR(40)      NULL,                        -- 어린이집 관리자명 
    `business_email`       VARCHAR(50)      NULL,                        -- 어린이집 이메일 
    ...
    `business_created_at`  DATETIME         NULL,                        -- 어린이집 등록일자 
    `manager_idx`          INT UNSIGNED     NULL,                        -- 관리자 순번 
...
(
    ...
    `user_created`     DATETIME        NULL,                        -- 직원 등록일자
    `user_updated_at`  DATETIME        NULL,                        -- 직원 수정일자
    `user_deleted_at`  DATETIME        NULL,                        -- 직원 삭제일자
    `user_role`        VARCHAR(30)     NULL,                        -- 직원 역할
    `user_last_login`  DATETIME        NULL,                        -- 직원 최종 로그인
    `business_idx`     INT UNSIGNED    NULL,                        -- 어린이집 순번
...
(
    ...
    `video_created_at`   DATETIME         NULL,                        -- 비디오 등록일자 
    `business_idx`       INT UNSIGNED     NULL,                        -- 어린이집 순번
...
(
    ...
    `menu_updated_at`  DATETIME        NULL,                        -- 메뉴 수정일자 
    `url_idx`          INT UNSIGNED    NULL,                        -- 도메인 순번 
...
(
    ...
    `logged_at`    DATETIME        NULL,                        -- 로그인 날짜
    `log_info`     VARCHAR(20)     NULL,                        -- 로그인 정보 
    `log_ip`       VARCHAR(20)     NULL,                        -- 로그인 아이피 
    `logouted_at`  DATETIME        NULL,                        -- 로그아웃 날짜 
    `manager_idx`  INT UNSIGNED    NULL,                        -- 관리자 순번
...
(
    ...
    `business_name`       VARCHAR(50)     NULL,                        -- 어린이집 이름 
    `content_created_at`  DATETIME        NULL,                        -- 컨텐츠 등록일자
    `content_updated_at`  DATETIME        NULL,                        -- 컨텐츠 수정일자
    `url_idx`             INT UNSIGNED    NULL,                        -- 도메인 순번 
